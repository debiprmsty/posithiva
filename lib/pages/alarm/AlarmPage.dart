...
class _AlarmPageState extends State<AlarmPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Alarm Obat Saya", style: lora.copyWith(color: Colors.black, fontSize: 35),),
                const SizedBox(
                  height: 15,
                ),
                Container(
      ...
      //     side: BorderSide(color: birutua, width: 4.0), 
      //   ),
      //   onPressed: () {
      //     Navigator.of(context).push(MaterialPageRoute(builder: (context) {
      //       return const SuksesAlarmPage();
      //     }));
      //   },
      //   child: Icon(Icons.add, color: birutua, size: 35,),
      // ),
    );
  }
}